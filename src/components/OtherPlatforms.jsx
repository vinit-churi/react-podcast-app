...
const OtherPlatforms = () => {
  return (
    <div className="h-72 bg-secondary flex items-center flex-col gap-12 justify-center">
      ...
      <div className="w-[90%] grid grid-cols-[repeat(5,1fr)] gap-4 custom-mask">
        <img src={compnay1Logo} className="w-[100px] block mx-auto" alt="" />
        <img src={compnay2Logo} className="w-[100px] block mx-auto" alt="" />
        <img src={compnay3Logo} className="w-[100px] block mx-auto" alt="" />
        <img src={compnay4Logo} className="w-[100px] block mx-auto" alt="" />
        <img src={compnay5Logo} className="w-[100px] block mx-auto" alt="" />
      </div>
    </div>
  );
};
